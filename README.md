...
| **Conversation** <br> <sub>Audio · Text · Vision</sub> | Inter-Dialog CL <br> Multimodal Graph Representation | Emotion Recognition <br> <sub>in Conversations</sub> | `ICASSP '26` `KOSOMBE '24` <br> `ESWA '26 (under review)` |
